            ...
            const catalogNumber = new Bloodhound({
                ...
                prefetch: {
                    ...
                    transform: function(data) {
                        ...
                        //! 会被缓存, 不会更新! , 需要在 浏览器 application 中 clear Stroge 选择清空所有缓存, 
                        //! 然后就会被执行这个函数 clear site data
                        console.log("输出到ctx.body里时会执行 transform函数", data);
                        return data;
                    }
                }
            });
