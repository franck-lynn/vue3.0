...
const config = {
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            ...
            /*
            不显式配置 vue-i18n 会出现如下警告
            You are running the esm - bundler build of vue - i18n.It is recommended 
            to configure your bundler to explicitly replace feature flag globals with 
            boolean literals to get proper tree - shaking in the final bundle.
            */
            // 显式指定 i18n 构建配置
