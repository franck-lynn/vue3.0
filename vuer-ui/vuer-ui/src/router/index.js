...
const routes = [
    { path: '/test-button', name: 'test-button', component: () => import('@/views/test-button.vue') },
    ...
    { path: '/test-progress-bar', name: 'test-progress-bar', component: () => import('@/views/test-progress-bar.vue') },
]
